...
\DeclareRobustCommand{\howto}{%
	\begingroup\normalfont
	\includegraphics[height=2 \fontcharht\font`\B]{/home/dg/PublicSensors/Textbooks/IntroSensors/Images/hammer2crop3.png}%
	\, \textbf{\textit{HOW-TO}:}
%	\includegraphics[height=1.25 
	%	\includegraphics[height=1.25 \fontcharht\font`\B]{/home/dg/PublicSensors/Textbooks/IntroSensors/Fritzing/pcb_image.png}%
%\, \textbf{\textit{HOW-TO}:}
	\endgroup
}
