...
In these cases, analternative strategy is provided by an \i2c \emph{multiplexer}.
...
A solution using an \i2c multiplexer is shown in \reffig{i2c_mulitplx}.
To use this circuit, we can use a modification of code posted on the \htmladdnormallink{MicroPython forum}{https://forum.micropython.org/viewtopic.php?t=6284}:
