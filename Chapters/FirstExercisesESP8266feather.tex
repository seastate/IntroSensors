...
\begin{marginfigure}[-0.cm]
	\begin{center}
		\htmladdnormallink{\includegraphics[width=\MFWn]{/home/dg/PublicSensors/Textbooks/IntroSensors/Fritzing/breadboard_bare.png}}{https://publicsensors.org/IntroSensors/Fritzing/breadboard_bare.png}
		\htmladdnormallink{\includegraphics[width=\MFWn]{/home/dg/PublicSensors/Textbooks/IntroSensors/Images/breadboard_back1_crop.png}	}{https://publicsensors.org/IntroSensors/Images/breadboard_back1_crop.png}
...
The holes in breadboards are shaped so that wires (often called \emph{jumpers}\sidenote[][*-10]{\begin{kaobox}[backgroundcolor=\SNcolor,frametitlebackgroundcolor=\SNcolor,frametitle=Wire we using jumpers?]
...
\begin{marginfigure}[-4 cm]
	\begin{center}
		\htmladdnormallink{\includegraphics[width=\MFW]{/home/dg/PublicSensors/Textbooks/IntroSensors/Fritzing/breadboard_connections.png}}{https://publicsensors.org/IntroSensors/Fritzing/breadboard_connections.png}
...
\begin{marginfigure}[-2cm]
	\htmladdnormallink{\includegraphics[width=\MFW]{/home/dg/PublicSensors/Textbooks/IntroSensors/Images/breadboard_ESP8266feather.jpg}}{https://publicsensors.org/IntroSensors/Images/breadboard_ESP8266feather.jpg}
...
\begin{marginfigure}[-5cm]
	\begin{center}
		\htmladdnormallink{\includegraphics[width=\MFW]{/home/dg/PublicSensors/Textbooks/IntroSensors/Fritzing/feather_rails.png}}{https://publicsensors.org/IntroSensors/Fritzing/feather_rails.png}
...
%	Use another jumper to connect an empty hole in the same row as the \texttt{USB} pin to any hole in the right side positive rail.
	...
	\sidenote[][*-12]{\begin{kaobox}[backgroundcolor=\SNcolor,frametitlebackgroundcolor=\SNcolor,frametitle=CAREFUL!]Make sure not to connect the positive and negative rails directly together --- for example by brushing the leads of the multimeter to each other while they are touching the rails. This would cause a short circuit that could damage your microcontroller!\end{kaobox}}
...
\sidenote[][*-16]{\begin{kaobox}[backgroundcolor=\SNcolor,frametitlebackgroundcolor=\SNcolor,frametitle=Button it up!]
...
\begin{marginfigure}[-0cm]
	\begin{center}
		\htmladdnormallink{\includegraphics[width=\MFW]{/home/dg/PublicSensors/Textbooks/IntroSensors/Fritzing/feather_switch.png}}{https://publicsensors.org/IntroSensors/Fritzing/feather_switch.png}
...
\begin{marginfigure}[-10cm]
	\begin{center}
		\htmladdnormallink{\includegraphics[width=\MFW]{/home/dg/PublicSensors/Textbooks/IntroSensors/Fritzing/feather_switch_LED.png}}{https://publicsensors.org/IntroSensors/Fritzing/feather_switch_LED.png}
...
\begin{marginfigure}[-10cm]
	\begin{center}
		\htmladdnormallink{\includegraphics[width=\MFW]{/home/dg/PublicSensors/Textbooks/IntroSensors/Fritzing/feather_switch_relay_LED.png}}{https://publicsensors.org/IntroSensors/Fritzing/feather_switch_relay_LED.png}
