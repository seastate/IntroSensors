...
\lstinputlisting[language=Python,label=SetTimeDS3231,caption={\htmladdnormallink{\texttt{SetTimeDS3231.py}}{https://github.com/seastate/IntroSensors/blob/main/Codes/SetTimeDS3231.py}: A Micropython utility to set a \DS3231 \rtc to time from a Network Time Protocol (NTP) server.}]{Codes/SetTimeDS3231.py}
...
\begin{kaobox}[frametitle=A download-able dataset of time-keeping errors]
	...
	If you do not have access to a sufficient number of devices, or if you would like to focus on understanding the data analysis rather than acquiring new data, you can download an \htmladdnormallink{archived dataset}{https://github.com/seastate/IntroSensors/tree/main/Codes/Data/TimeData} of time-keeping errors.
...
\end{lstlisting}
	...
	\begin{itemize}
		...
		\sidenote[][*-18]{\begin{kaobox}[backgroundcolor=\SNcolor,frametitlebackgroundcolor=\SNcolor,frametitle=Time-saving tricks]
...
In this and the following sections, you can use either your own data or the \htmladdnormallink{archived dataset}{https://github.com/seastate/IntroSensors/tree/main/Codes/Data/TimeData} to demonstrate steps in the statistical analysis. 
...
\end{lstlisting}	
	...
	\item \textbf{Download the file}  \htmladdnormallink{TimeAccPrec.py}{https://github.com/seastate/IntroSensors/blob/main/Codes/TimeAccPrec.py}\textbf{ onto your computer.}
...
%– accumulate data for the violin plots, at the sample numbers specified in the list \lstinline{violin_samples} (line 25). 
	...
	\item \textbf{If you will use the archived dataset, download the}  \htmladdnormallink{TimeData}{https://github.com/seastate/IntroSensors/tree/main/Codes/Data/TimeData}\textbf{ directory onto your computer.}
...
\end{lstlisting}
	...
	\begin{itemize}
		\item[$\circ$] This example assumes the \lstinline{TimeData} subdirectory is in the same directory that contains \htmladdnormallink{TimeAccPrec.py}{https://github.com/seastate/IntroSensors/blob/main/Codes/TimeAccPrec.py} and from which you launched the \python session.
