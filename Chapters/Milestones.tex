...
\begin{kaobox}[backgroundcolor=\MScolor,frametitlebackgroundcolor=\MScolor,frametitle=\showmscntr Milestone: Writing a driver for a \texttt{TSL237} light sensor]
	\begin{itemize}
		...
		\item[$\circ$] The first line is a \texttt{definition} statement, e.g. \\
	 	...
	 	This line defines a new function called  \lstinline{def readTSL237}, specifying it has the required arguments \lstinline{pd,nrep,timeout}. \,
	 	These are the parameters needed to pass to \lstinline{median_of_n} to measure the period of the \texttt{TSL237} signal.
	
		\item[$\circ$] In the body of the function, call \lstinline{median_of_n} with the parameters needed to measure the period of the \texttt{TSL237} signal.
	...
	When you have a working driver, complete the assignment by uploading: (a) your driver and the code you used to get measurements using it; and, (b) five to ten measurements of nominal irradiance across a range of light levels.
\end{kaobox}
%</mlst:04f>
