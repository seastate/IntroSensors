...
%
      ...
      5. \textbf{Digital interfaces for environmental sensors}   & 5.0.1 Communicating with digital sensors &    & &        &      \\
          5.1 I2C sensors   & 5.1.1 Background &      \\
             & 5.1.2 Measuring temperature with a high-resolution sensor   & Measure temperature with an MCP9808 precision temperature sensor &        &    \\
             & 5.1.5 Using I2C over long cables with differential extenders   & Implement an I2C sensor over an ethernet cable &        &    \\
          5.2 1-wire sensors   &  5.2.1 Background &      \\
             ...
             & 5.2.4 Accuracy \& precision of DS18B20 temperature sensors & Quantify errors with a high-resolution temperature sensor   &   &        &    \\
             &  & Improve the accuracy of DS18B20 temperature measurements with recalibration   &   &        &    \\
             & 5.2.5 Monitoring temperature changes across time & Log samples to generate a temperature time series   &   &        &    \\
...
%
      ...
      9.  \textbf{Environmental effects on electrical characteristics}   &  &    & &        &      \\
          ...
          9.5 Electrical effects of shape \& deformation & 9.5.1 Engineering stress \& strain & & & & \\
                 & 9.5.2 Piezo-electric materials & & & & \\
                 & 9.5.3 Strain gauges & Measure strain with a Wheatstone bridge & & & \\
%
%
      ...
      13.  \textbf{Water- \& weather-proofing environmental sensing instruments} & & & & & \\
%
%
      ...
      15. Monitoring meteorologial conditions \& air chemistry
          15.1 Monitoring air flow & 15.1.1 Measuring wind speed   & Build and calibrate an anemometer &      \\
                 & 15.1.2 Measuring wind direction   & Build and calibrate a wind vane &      \\
          15.2 Air chemistry measurements & 15.2.1 Measuring $CO_2$ concentration   & Build and calibrate a $CO_2$ monitor &      \\
                 & 15.2.2 Ventilation of interior spaces   & Estimate air replacement rates with a $CO_2$ monitor &      \\
          15.3 Monitoring particulate pollutants and the Air Quality Index  &  15.3.1 Light scattering by atmospheric pollution particles & Use scattering to measure Air Quality Index   &  &        &    \\

      16. \textbf{Monitoring water level \& flow}   &  &    & &        &      \\
          16.1 Monitoring water level  & 16.1.1 Hydrostatics \& hydrodynamics & & & & \\
                 & 16.1.2 Measure water height with an acoustic distance sensor & & & & \\
                 & 16.1.3 Measure water height with a pressure sesor & & & & \\
          16.2 Monitoring rainfall   & 16.2.1 Sensing magnetism with Hall effect sensors & Measure signals from latching, non-latching and linear Hall effect sensors   & &        &      \\
                 & 16.2.2 Construct a tipping rain gauge & & & & \\
          16.3 Monitoring flow of air \& water   & 16.3.1 Measuring pipe flow   & Measure flow with a yf-s201c flow meter &      \\
                 & 16.3.2 Measuring wind speed   & Build and calibrate an anemometer &      \\
                 & 16.3.3 Measuring wind direction   & Build and calibrate a wind vane &      \\
                 & Measuring velocity of water currents   & Build and calibrate a taffrail log &      \\
          16.4 Monitoring waves \& tides   & 16.4.1 Characteristics of water waves & Measure wave amplitude \& frequency with an acoustic distance sensor  & &        &      \\
                 & 16.4.2 Resolving fluctuating signals: Aliasing, Nyquist frequencies \& noise reduction & Assess sampling requirements for resolving water waves & & & \\
                 & 16.4.3 Measurement \& prediction of tides & Analyze a water height time series to predict tides & & & \\



      17.  \textbf{Tracking position, displacement, velocity \& orientation} & & & & & \\
};
% % Simple brace
% \draw [-,decorate,
