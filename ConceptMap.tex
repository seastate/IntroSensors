...
%	  column 9/.style = {nodes={background}}
    ]
    {
      ...
      3.3 Accuracy \& precision of time-keeping on the ESP8266    & 3.3.1 Generating a dataset of time-keeping errors & Generate a time-keeping dataset   & Python coding (File I/O, data logging) &          \\
       ...
       \textbf{PART II: FUNDAMENTALS OF ENVIRONMENTAL SENSING}   & &      & &        &      \\
      ...
      6.2 Microcontroller-based web servers   & 6.2.1 Web server setup \& testing &    & &        &      \\
       ...
       \textbf{PART III: WORKING WITH ENVIRONMENTAL SENSORS}   & &      & &        &      \\

      7. \textbf{Measuring heat and energy flow}   &  &    & &        &      \\
                 ...
                 & & Heat transport by turbuent mixing   &  &        &    \\
                 & 5.2.6 Heating \& cooling using a Peltier (thermoelectric) device & Assemble and code a digital thermostat  & Power modulation \& control & & Feedback \& control   \\

      8.  \textbf{Quantifying light \& color}   &  &    & &        &      \\
          8.1 Dispersion of collimated \& diffuse light beams  & 8.1.1 Energy conservation \& the $r^2$ law &    &    &    \\
          8.2 Light attentuation \& scattering through the water column & 8.2.1 Color-dependence of light absorption  & Digital devices (I2C) &        &    \\
                 &  & 8.2.2 Construct a turbidity sensor   &  &        &    \\
                 & Light scattering by atmospheric pollution particles & 8.2.3 Use scattering to measure Air Quality Index   &  &        &    \\
      ...
      9.  \textbf{Environmental effects on electrical characteristics}   &  &    & &        &      \\
          ...
          9.2 Conductivity  & 9.2.1  Make a conductivity sensor &    &    &    \\
            % & 9.1.2  Use a capacitance touchpad as a Human Interface Devices  &    &    &    \\



       \textbf{PART IV: QUANTIFYING ENVIRONMENTAL PROCESSES}   & &      & &        &      \\

      10. \textbf{Monitoring flow of air \& water}   &  &    & &        &      \\
      10.1 ****Sensing magnetism with Hall effect sensors & Measuring current and wind velocity   &  &      \\
%
      11.  \textbf{Tracking position, displacement, velocity \& orientation} & & & & & \\
%
%
      %
      %1.1 Estab. Comms    &  &    & &        &      \\
