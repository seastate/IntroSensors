...
%
      ...
      \stepcounter{chptno}\thechptno. \textbf{Communicating w/ your microcontroller} & & Meet your microcontroller & & & \\
              & \thechptno.0.1 Meet your microcontroller &  &  &        &      \\
...
%
      ...
      \stepcounter{chptno}\thechptno. \textbf{Environmental sensing w/ voltage, current and resistance}   &  &    & &        &      \\
          ...
          \thechptno.2 Environmental sensing w/ voltage: measure temperature & Thermistor temperature resistance curves & Calibrate a thermistor   & &   Temperature effects on sensors     &      \\
          ...
          \thechptno.3 Environmental sensing w/ voltage: measure electrical conductivity & \thechptno.2.1 What is EC?  Why does it depend on temperature? & & & & Relationship between EC and salinity/water quality \\
              & \thechptno.3.1 EC circuit assembly \& programming & build \& test an EC circuit  & Signal acquisition (current measurement, 2 wire vs. 4 wire) & AC vs. DC, electrical fields & \\
              & \thechptno.3.2 EC circuit calibration & Calibrate EC circuit w/ KCl Standard & Regression/optimization in Python & & Accuracy vs. precision, bias  \\
          \thechptno.4 Environmental sensing w/ time: measuring light intensity with frequency    & \thechptno.4.1 Measuring light with frequency & Assemble \& test a frequency-based light sensor circuit   & Breadboard circuit layout \& debugging &        &      \\
              & \thechptno.4.2 Dividing frequency to increase sensor range & Measure divided frequency from a light sensor   & GPIO interfaces & Microcontroller responses to environmental signals       &      Sensor range, resolution \& saturation ($\mu s$ measurement limits)\\
              & \thechptno.4.3 Optimizing a light sensor driver & Optimize a light sensor driver   & Python coding (drivers) &        &      \\
          \thechptno.5 Environmental sensing with time: Calibrate an acoustic distance sensor   &  &      \\
...
%
       |[part]| \textbf{PART III: EXPERIMENTS WITH ENVIRONMENTAL SENSORS}   & &      & &        &      \\
      %
      \stepcounter{chptno}\thechptno. \textbf{Best practices for data management}   & \thechptno.1 Deployment metadata  &    & &        &      \\
      ...
      \stepcounter{chptno}\thechptno. \textbf{Measuring heat and energy flow}   & \thechptno.1 Background: Conservation \& diffusion (conduction) of heat  &    & &        &      \\
          ...
          \thechptno.4 Heating and cooling of lakes \& oceans & \thechptno.4.1 Stratification and advective heat transfer in lakes \& oceans &   &  &        &    \\
                  & \thechptno.4.2 Laboratory models of lakes \& oceans & Monitor temperature in a laboratory column during heating \& cooling   &  &        &    \\
                 & \thechptno.4.3 Heat transport in salinity-stratified water columns   &  Monitor temperature in a stratified laboratory column during heating \& cooling  &        &    \\
                 & \thechptno.4.4 Heat transport by turbuent mixing   &  Monitor temperature in a mixed laboratory column during heating \& cooling  &        &    \\
...
%
      ...
      \stepcounter{appno}\Alph{appno}. \textbf{Overview of selected microcontrollers} & &  & \\
          \theappno.1 Adafruit Feather form factor microcontrollers & & & \\
          \theappno.2 STM32-based microcontrollers (Pyboards \& related) & & & \\
          \theappno.3 ESP32-based microcontrollers & & & \\
                 & \thechptno.3.1 Lolin D32 Pro &  & & & \\

          \theappno.3 ESP8266-based microcontrollers & & & \\
